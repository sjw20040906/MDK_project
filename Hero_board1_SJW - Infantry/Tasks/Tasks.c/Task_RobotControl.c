...
void Robot_Control(void const *argument)
{
    ...
    for (;;)
    {
        ...
        M3508_setCurrent(M3508_Array[FricL_Wheel].outCurrent, M3508_Array[FricR_Wheel].outCurrent, M2006_Array[Dial_Motor].outCurrent, M2006_Array[Dial_Motor].outCurrent, data1);
