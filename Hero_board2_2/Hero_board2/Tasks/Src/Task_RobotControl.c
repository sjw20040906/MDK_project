...
void Robot_Control(void const *argument)
{
    ...
    for (;;)
    {
        ...
        DM_setParameter(DM_Offset+DM_Offset_temp, DM_Speed, DM_KP, DM_KD, DM_Torque, data1);
        DM_setParameter(DM_Offset-DM_Offset_temp, DM_Speed, DM_KP, DM_KD, DM_Torque, data2);
        DM_setParameter(DM_Offset+DM_Offset_temp, DM_Speed, DM_KP, DM_KD, DM_Torque, data3);
        DM_setParameter(DM_Offset-DM_Offset_temp, DM_Speed, DM_KP, DM_KD, DM_Torque, data4);
        /****************发送电流数据***************/
