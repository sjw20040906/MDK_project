...
DM_Motor_t DM_Array[totalMotor] = {0};
...
void DM_getInfo(Can_Export_Data_t RxMessage)
{
  ...
  StdId = (int32_t)RxMessage.CAN_RxHeader.StdId - DM_LF_ReadID;
  ...
  int32_t delta = DM_Array[StdId].angleInit - DM_Array[StdId].lastAngle;
  if (delta < -(1 << 15))
  {
