...
void Robot_Control(void const *argument)
{
    ...
    for (;;)
    {
        ...
        M3508_FUN.M3508_setCurrent(M3508_Array[Fric_Left].outCurrent, M3508_Array[Fric_Right].outCurrent, 0, 0, data1);
        ...
        J3519_Fun.J3519_setParameter(J3519_Array[J3519_Dail_Wheel].outPosition, J3519_Array[J3519_Dail_Wheel].outSpeed, J3519_Array[J3519_Dail_Wheel].outKp, J3519_Array[J3519_Dail_Wheel].outKd, J3519_Array[J3519_Dail_Wheel].outTorque, data3);
